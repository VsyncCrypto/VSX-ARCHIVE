...
#   c) node1 mines 32 blocks, so now node 0 has 60001vsx, node 1 has 4250vsx, node2 has none.
#   d) node0 sends 601 vsx to node2, in two transactions (301 vsx, then 300 vsx).
